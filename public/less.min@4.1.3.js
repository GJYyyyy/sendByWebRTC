...
!function(e, t) {
    ...
    var i = function(t, i, n) {
      ...
      , s = function() {
        ...
        return e.prototype.getFileManager = function(e, t, i, n, s) {
            ...
            null == t && r.warn("getFileManager called with null directory.. Please report this issue. continuing.");
    ...
    F.prototype = Object.assign(new u, {
        ...
        createDerived: function(e, t, i) {
            ...
            return n.evaldCondition = null != i ? i : this.evaldCondition,
        ...
        match: function(e) {
            ...
            if (0 === (t = (e = e.mixinElements()).length) || r < t)
                return 0;
            for (i = 0; i < t; i++)
                if (n[i].value !== e[i])
                    return 0;
    ...
    D.prototype = Object.assign(new u, {
        ...
        eval: function(e) {
            ...
            s = !1),
            "font" === r && e.math === N.ALWAYS && (n = !0,
            t = e.math,
            e.math = N.PARENS_DIVISION);
            try {
                ...
                return !o && a.important && (o = a.important),
                new D(r,i,o,this.merge,this.getIndex(),this.fileInfo(),this.inline,s)
            } catch (e) {
                throw "number" != typeof e.index && (e.index = this.getIndex(),
    ...
    T.prototype = Object.assign(new u, {
        type: "Comment",
        genCSS: function(e, t) {
            this.debugInfo && t.add(q(e, this), this.fileInfo(), this.getIndex()),
            t.add(this.value)
        },
        isSilent: function(e) {
    ...
    X.prototype = Object.assign(new u, {
        ...
        eval: function(e) {
            ...
            if (this.selectors && (i = this.selectors.length)) {
                ...
                o = !0;
            var c, h, f = this.rules ? k(this.rules) : null, p = new X(t,f,this.strictImports,this.visibilityInfo());
            ...
            var m = p.rules;
            for (r = 0; c = m[r]; r++)
                c.evalFirst && (m[r] = c.eval(e));
            var g = e.mediaBlocks && e.mediaBlocks.length || 0;
            for (r = 0; c = m[r]; r++)
                "MixinCall" === c.type ? (f = c.eval(e).filter((function(e) {
                    return !(e instanceof D && e.variable) || !p.variable(e.name)
                }
                )),
                m.splice.apply(m, [r, 1].concat(f)),
                r += f.length - 1,
                p.resetCache()) : "VariableCall" === c.type && (f = c.eval(e).rules.filter((function(e) {
        ...
        evalImports: function(e) {
            ...
            if (n)
                for (t = 0; t < n.length; t++)
                    "Import" === n[t].type && ((i = n[t].eval(e)) && (i.length || 0 === i.length) ? (n.splice.apply(n, [t, 1].concat(i)),
                    t += i.length - 1) : n.splice(t, 1, i),
                    this.resetCache())
        },
        makeImportant: function() {
        ...
        variables: function() {
            return this._variables || (this._variables = this.rules ? this.rules.reduce((function(e, t) {
                if (t instanceof D && !0 === t.variable && (e[t.name] = t),
        ...
        genCSS: function(e, t) {
            ...
            var l, u = e.compress ? "" : Array(e.tabLevel + 1).join("  "), c = e.compress ? "" : Array(e.tabLevel).join("  "), h = 0, f = 0;
            for (i = 0; s = this.rules[i]; i++)
                s instanceof T ? (f === i && f++,
                a.push(s)) : s.isCharset && s.isCharset() ? (a.splice(h, 0, s),
                h++,
                f++) : "Import" === s.type ? (a.splice(f, 0, s),
                f++) : a.push(s);
            if (a = [].concat(a),
            !this.root) {
                (r = q(e, this, c)) && (t.add(r),
                t.add(c));
                var p = this.paths
                  , v = p.length
                  , d = void 0;
        ...
        joinSelector: function(e, t, i) {
            ...
            function r(e, t) {
                var i;
                return i = new m(null,e,t.isVariable,t._index,t._fileInfo),
                new F([i])
            }
            function s(e, t, i, n) {
                var r, s, o;
                if (r = [],
                e.length > 0 ? (s = (r = k(e)).pop(),
                o = n.createDerived(k(s.elements))) : o = n.createDerived([]),
                t.length > 0) {
                    var a = i.combinator
                      , l = t[0].elements[0];
                ...
                if (0 !== o.elements.length && r.push(o),
                t.length > 1) {
                    var u = t.slice(1);
                    u = u.map((function(e) {
            ...
            function a(e, t) {
                ...
                if (0 !== e.length)
                    if (0 !== t.length)
                        for (i = 0; n = t[i]; i++)
                            n.length > 0 ? n[n.length - 1] = n[n.length - 1].createDerived(n[n.length - 1].elements.concat(e)) : n.push(new F(e));
                    else
                        t.push([new F(e)])
            }
            function l(e, t) {
                ...
                u = 0; y = l.elements[u]; u++)
                    if ("&" !== y.value) {
                        ...
                        c = 0; c < v.length; c++)
                            if (g = v[c],
                            0 === i.length)
                                g.length > 0 && g[0].elements.push(new m(y.combinator,"",y.isVariable,y._index,y._fileInfo)),
                                d.push(g);
                            else
    ...
    var Y = function(e, t, i, n, r, s, o, a) {
        ...
        i) {
            for (Array.isArray(i) ? this.rules = i : (this.rules = [i],
            this.rules[0].selectors = new F([],null,null,n,r).createEmptySelectors()),
            l = 0; l < this.rules.length; l++)
    ...
    Y.prototype = Object.assign(new u, {
        ...
        eval: function(e) {
            ...
            e.mediaPath = t,
            e.mediaBlocks = i,
            new Y(this.name,n,r,this.getIndex(),this.fileInfo(),this.debugInfo,this.isRooted,this.visibilityInfo())
        },
        variable: function(e) {
            if (this.rules)
                return X.prototype.variable.call(this.rules[0], e)
        },
        find: function() {
            if (this.rules)
        ...
        rulesets: function() {
            if (this.rules)
                return X.prototype.rulesets.apply(this.rules[0])
        },
    ...
    te.prototype = Object.assign(new u, {
        ...
        usedUnits: function() {
            ...
            for (i in t = function(t) {
                return e.hasOwnProperty(t) && !n[i] && (n[i] = t),
                t
            }
            ,
            a)
                a.hasOwnProperty(i) && (e = a[i],
                this.map(t));
            return n
        },
        cancel: function() {
    ...
    ie.prototype = Object.assign(new u, {
            ...
            if ("+" === t || "-" === t)
                if (0 === r.numerator.length && 0 === r.denominator.length)
                    ...
                    e.strictUnits && i.unit.toString() !== r.toString())
                        throw new Error("Incompatible units. Change the units or use the unit function. Bad units: '" + r.toString() + "' and '" + i.unit.toString() + "'.");
                    n = this._operate(e, t, this.value, i.value)
                }
            else
                "*" === t ? (r.numerator = r.numerator.concat(i.unit.numerator).sort(),
                r.denominator = r.denominator.concat(i.unit.denominator).sort(),
                r.cancel()) : "/" === t && (r.numerator = r.numerator.concat(i.unit.denominator).sort(),
        ...
        convertTo: function(e) {
            ...
            if ("string" == typeof e) {
                for (t in a)
                    a[t].hasOwnProperty(e) && ((u = {})[t] = e);
                e = u
            }
            for (i in s = function(e, t) {
                return n.hasOwnProperty(e) ? (t ? o /= n[e] / n[r] : o *= n[e] / n[r],
                r) : e
            }
            ,
            e)
                e.hasOwnProperty(i) && (r = e[i],
                n = a[i],
                l.map(s));
            return l.cancel(),
            new ie(o,l)
    ...
    re.prototype = Object.assign(new u, {
        ...
        eval: function(e) {
            ...
            if (e.isMathOn(this.op)) {
                ...
                !i.operate || !n.operate) {
                    if ((i instanceof re || n instanceof re) && "/" === i.op && e.math === ne.PARENS_DIVISION)
    ...
    se.prototype = Object.assign(new u, {
        ...
        eval: function(e) {
            ...
            return n && e.inParenthesis(),
            this.value.length > 1 ? t = new se(this.value.map((function(t) {
                return t.eval ? t.eval(e) : t
            }
            )),this.noSpacing) : 1 === this.value.length ? (!this.value[0].parens || this.value[0].parensInOp || e.inCalc || (r = !0),
            t = this.value[0].eval(e)) : t = this,
            n && e.outOfParenthesis(),
            !this.parens || !this.parensInOp || i || r || t instanceof ie || (t = new p(t)),
            t
        },
        genCSS: function(e, t) {
    ...
    ae.prototype = Object.assign(new u, {
        ...
        eval: function(e) {
            ...
            if (null != n)
                return n instanceof u || (n = new j(n && !0 !== n ? n.toString() : null)),
            ...
            return r(),
            new ae(this.name,o,this.getIndex(),this.fileInfo())
        },
        genCSS: function(e, t) {
            t.add(this.name + "(", this.fileInfo(), this.getIndex());
    ...
    le.prototype = Object.assign(new u, {
        ...
        eval: function(e) {
            var t, i = this.name;
            if (0 === i.indexOf("@@") && (i = "@" + new le(i.slice(1),this.getIndex(),this.fileInfo()).eval(e).value),
            this.evaluating)
                throw {
                    type: "Name",
            ...
            t = this.find(e.frames, (function(t) {
                ...
                if (s) {
                    for (var o = 0; o < s.length; o++)
                        r = s[o],
                        s[o] = new D(r.name,r.value,r.important,r.merge,r.index,r.currentFileInfo,r.inline,r.variable);
                    if (n(s),
                    (r = s[s.length - 1]).important)
    ...
    fe.prototype = Object.assign(new u, {
        ...
        eval: function(e) {
            ...
            i.value = e.rewritePath(i.value, t)) : i.value = e.normalizePath(i.value),
    ...
    pe.prototype = Object.assign(new Y, {
        ...
        eval: function(e) {
            ...
            return this.debugInfo && (this.rules[0].debugInfo = this.debugInfo,
        ...
        bubbleSelectors: function(e) {
            e && (this.rules = [new X(k(e),[this.rules[0]])],
            this.setParent(this.rules, this))
        }
    });
    ...
    ve.prototype = Object.assign(new u, {
        ...
        evalForImport: function(e) {
            ...
            new ve(t.eval(e),this.features,this.options,this._index,this._fileInfo,this.visibilityInfo())
        },
        evalPath: function(e) {
        ...
        doEval: function(e) {
            ...
            return this.root ? ((t = new X(null,k(this.root.rules))).evalImports(e),
    ...
    Se.prototype = Object.assign(new u, {
        type: "VariableCall",
        eval: function(e) {
            var t, i = new le(this.variable,this.getIndex(),this.fileInfo()).eval(e), n = new O({
        ...
        eval: function(e) {
            ...
            for (t = 0; t < this.lookups.length; t++) {
                ...
                "" === i)
                    ...
                    if ("@" === i.charAt(1) && (i = "@" + new le(i.substr(1)).eval(e).value),
                    ...
                    if (i = "$@" === i.substring(0, 2) ? "$" + new le(i.substr(1)).eval(e).value : "$" === i.charAt(0) ? i : "$" + i,
    ...
    Ce.prototype = Object.assign(new X, {
        ...
        evalParams: function(e, t, i, n) {
            var r, s, o, a, l, u, c, h, f = new X(null,null), p = k(this.params), v = 0;
            if (t.frames && t.frames[0] && t.frames[0].functionRegistry && (f.functionRegistry = t.frames[0].functionRegistry.inherit()),
                ...
                if (!n[o]) {
                    ...
                    u = p[o].name)
                        if (p[o].variadic) {
                            ...
                            if (l = s && s.value)
                                l = Array.isArray(l) ? new ee(new X("",l)) : l.eval(e);
                            else {
                                if (!p[o].value)
                                    throw {
                                        type: "Runtime",
        ...
        evalCall: function(e, t, i) {
            var n, r, s = [], o = this.frames ? this.frames.concat(e.frames) : e.frames, a = this.evalParams(e, new z.Eval(e,o), t, s);
            return a.prependRule(new D("@arguments",new se(s).eval(e))),
            n = k(this.rules),
    ...
    ke.prototype = Object.assign(new u, {
        ...
        eval: function(e) {
            ...
            o = 0; o < this.arguments.length; o++)
                if (s = (r = this.arguments[o]).value.eval(e),
                ...
                if ((t = e.frames[o].find(this.selector, null, d)).length > 0) {
                    ...
                    for (a = 0; a < b.length; a++)
                        if (0 === (h = b[a].group) || h === f)
                            try {
                                (i = b[a].mixin)instanceof Ce || (v = i.originalRuleset || i,
                                (i = new Ce("",[],i.rules,null,!1,null,v.visibilityInfo())).originalRuleset = v);
    ...
    var _e = {
      ...
      , Ae = function() {
        ...
        e.prototype.pathDiff = function(e, t) {
            ...
            if (o.hostPart !== a.hostPart)
                return "";
            for (n = Math.max(a.directories.length, o.directories.length),
            i = 0; i < n && a.directories[i] === o.directories[i]; i++)
                ;
            for (s = a.directories.slice(i),
        ...
        e.prototype.extractUrlParts = function(e, t) {
            var i, n, r = /^((?:[a-z-]+:)?\/{2}(?:[^\/\?#]*\/)|([\/\\]))?((?:[^\/\\\?#]*[\/\\])*)([^\/\\\?#]*)([#\?].*)?$/i, s = e.match(r), o = {}, a = [], l = [];
            if (!s)
            ...
            if (s[3])
                for (a = s[3].replace(/\\/g, "/").split("/"),
                i = 0; i < a.length; i++)
                    ".." === a[i] ? l.pop() : "." !== a[i] && l.push(a[i]);
            return o.hostPart = s[1],
            o.directories = l,
      ...
      , Me = function() {
        ...
        return e.prototype.evalPlugin = function(e, t, i, n, r) {
            ...
            if (u && (o = l.get(u))) {
                if (c = this.trySetOptions(o, u, h, n))
                    return c;
                try {
            ...
            if (o.imports = i,
            o.filename = u,
            (!o.minVersion || this.compareVersion("3.0.0", o.minVersion) < 0) && (c = this.trySetOptions(o, u, h, n)))
                return c;
            if (l.addPlugin(o, r.filename, s),
        ...
        e.prototype.validatePlugin = function(e, t, i) {
            ...
            e.minVersion && this.compareVersion(e.minVersion, this.less.version) < 0 ? new O({
    ...
    var Oe = function() {
        ...
        return e.prototype.visit = function(e) {
            ...
            if (!t)
                ...
                e;
            var i, n = this._implementation, r = this._visitInCache[t], s = this._visitOutCache[t], o = Ee;
            if (o.visitDeeper = !0,
            r || (r = n[i = "visit" + e.type] || Re,
            s = n[i + "Out"] || Re,
        ...
        visitImport: function(e, t) {
            ...
            if (!e.css || i) {
                var n = new z.Eval(this.context,k(this.context.frames))
                  , r = n.frames[0];
                this.importCount++,
                e.isVariableImport() ? this._sequencer.addVariableImport(this.processImportNode.bind(this, e, n, r)) : this.processImportNode(e, n, r)
            }
            t.visitDeeper = !1
        },
    ...
    var $e = function() {
      ...
      , Le = function() {
        ...
        e.prototype.visitRuleset = function(e, t) {
            if (!e.root) {
                ...
                for (i = 0; i < l; i++)
                    e.rules[i]instanceof _e.Extend && (o.push(a[i]),
      ...
      , je = function() {
        ...
        e.prototype.doExtendChaining = function(e, t, i) {
            ...
            n = 0; n < e.length; n++)
                for (r = 0; r < t.length; r++)
                    l = e[n],
                    u = t[r],
                    l.parent_ids.indexOf(u.object_id) >= 0 || (a = [u.selfSelectors[0]],
                    (s = f.findMatch(l, a)).length && (l.hasFoundMatches = !0,
                    l.selfSelectors.forEach((function(e) {
                        var t = u.visibilityInfo();
                        o = f.extendSelector(s, a, e, l.isVisible()),
                        (c = new _e.Extend(u.selector,u.option,0,u.fileInfo(),t)).selfSelectors = o,
                        o[o.length - 1].extendList = [c],
                        h.push(c),
                        c.ruleset = u.ruleset,
                        c.parent_ids = c.parent_ids.concat(u.parent_ids, l.parent_ids),
                        u.firstExtendOnThisSelectorPath && (c.firstExtendOnThisSelectorPath = !0,
                ...
                for (r = 0; r < o.length; r++)
                    for (n = 0; n < e.paths.length; n++)
                        ...
                        !e.extendOnEveryPath) {
                            ...
                            u && u.length || (i = this.findMatch(o[r], s)).length && (o[r].hasFoundMatches = !0,
            ...
            for (i = 0; i < t.length; i++)
                ...
                r = 0; r < n.elements.length; r++)
                    ...
                    a = 0; a < c.length; a++)
                        ...
                        !this.isElementValuesEqual(u[l.matched].value, s.value) || l.matched > 0 && u[l.matched].combinator.value !== o ? l = null : l.matched++,
                        l && (l.finished = l.matched === u.length,
                        l.finished && !e.allowAfter && (r + 1 < n.elements.length || i + 1 < t.length) && (l = null)),
                        l ? l.finished && (l.length = u.length,
                        l.endPathIndex = i,
                        l.endPathElementIndex = r + 1,
                        c.length = 0,
                        h.push(l)) : (c.splice(a, 1),
                        a--);
            return h
        }
        ,
        e.prototype.isElementValuesEqual = function(e, t) {
            ...
            if (e = e.value,
            t = t.value,
            e instanceof _e.Selector) {
                if (!(t instanceof _e.Selector) || e.elements.length !== t.elements.length)
                    return !1;
        ...
        e.prototype.extendSelector = function(e, t, i, n) {
            ...
            for (r = 0; r < e.length; r++)
                s = t[(a = e[r]).pathIndex],
                o = new _e.Element(a.initialCombinator,i.elements[0].value,i.elements[0].isVariable,i.elements[0].getIndex(),i.elements[0].fileInfo()),
                ...
                u === a.pathIndex && r > 0 ? h[h.length - 1].elements = h[h.length - 1].elements.concat(l) : (h = h.concat(t.slice(u, a.pathIndex))).push(new _e.Selector(l)),
                u = a.endPathIndex,
                (c = a.endPathElementIndex) >= t[u].elements.length && (c = 0,
                u++);
      ...
      , Ne = function() {
        ...
        e.prototype.visitRuleset = function(e, t) {
            ...
            e.root || ((i = e.selectors) && (i = i.filter((function(e) {
      ...
      , De = function() {
        ...
        e.prototype.resolveVisibility = function(e, t) {
            ...
            var i = e.rules[0];
            if (this.keepOnlyVisibleChilds(i),
            !this.isEmpty(i))
    ...
    Be.prototype = {
                ...
                if ("@charset" === e.name) {
                    if (this.charset) {
                        if (e.debugInfo) {
                            ...
                            return i.debugInfo = e.debugInfo,
        ...
        visitRuleset: function(e, t) {
            ...
            e.root)
                ...
                for (var r = e.rules, s = r ? r.length : 0, o = 0; o < s; )
                    (i = r[o]) && i.rules ? (n.push(this._visitor.visit(i)),
                    r.splice(o, 1),
                    s--) : o++;
        ...
        _compileRulesetPaths: function(e) {
            e.paths && (e.paths = e.paths.filter((function(e) {
                var t;
                for (" " === e[0].elements[0].combinator.value && (e[0].elements[0].combinator = new _e.Combinator("")),
                t = 0; t < e.length; t++)
                ...
                i.forEach((function(e) {
                    if (e.length > 0) {
                        ...
                        e.forEach((function(e) {
                            "+" === e.merge && i.length > 0 && n.push(new _e.Expression(i = [])),
                            i.push(e.value),
    ...
    var qe = function() {
        ...
        function u(i) {
            for (var n, a, c, h = l.i, f = t, p = l.i - o, v = l.i + s.length - p, d = l.i += i, m = e; l.i < v; l.i++) {
                ...
                if (32 !== n && 10 !== n && 9 !== n && 13 !== n)
                    break
            }
            if (s = s.slice(i + l.i - d + p),
            o = l.i,
            !s.length) {
                if (t < r.length - 1)
                    return s = r[++t],
        ...
        ,
        l.$char = function(t) {
            return e.charAt(l.i) !== t ? null : (u(1),
            t)
        }
        ,
        l.$str = function(t) {
        ...
        l.$parseUntil = function(t) {
            ...
            do {
                ...
                if (0 === o && i(m))
                    ...
                    case "'":
                    case '"':
                        (n = l.$quoted(v)) ? (c.push(e.substr(p, v - p), n),
                        p = (v += n[1].length - 1) + 1) : (u(v - f),
                        r = m,
                        d = !1);
                        break;
                    case "{":
        ...
        l.start = function(n, a, c) {
            ...
            r = a ? function(e, t) {
                ...
                function m(t) {
                    var i = o - d;
                    i < 512 && !t || !i || (v.push(e.slice(d, o + 1)),
                    d = o + 1)
                }
                for (o = 0; o < h; o++)
                    if (!((l = e.charCodeAt(o)) >= 97 && l <= 122 || l < 34))
                        ...
                        case 47:
                            ...
                            if (47 == (u = e.charCodeAt(o + 1)))
                                ...
                                for (r = a = o,
                                o += 2; o < h - 1 && (125 == (u = e.charCodeAt(o)) && (s = o),
                                42 != u || 47 != e.charCodeAt(o + 1)); o++)
                                    ;
                                if (o == h - 1)
                                    return t("missing closing `*/`", a);
                                o++
                            }
                            continue;
                        case 42:
                ...
                return 0 !== f ? t(r > i && s > r ? "missing closing `}` or `*/`" : "missing closing `}`", i) : 0 !== p ? t("missing closing `)`", n) : (m(!0),
                v)
            }(n, c) : [n],
            s = r[0],
            u(0)
      ...
      , Te = function e(t, i, n) {
        ...
        return {
            ...
            parse: function(a, l, u) {
                ...
                t.pluginManager)
                    for (var m = t.pluginManager.getPreProcessors(), g = 0; g < m.length; g++)
                        a = m[g].process(a, {
                            context: t,
                            imports: i,
                            fileInfo: n
                        });
                (h || u && u.banner) && (d = (u && u.banner ? u.banner : "") + h,
                ...
                if (!y.isFinished) {
                    ...
                    b || (b = "Unrecognised input",
                    "}" === y.furthestChar ? b += ". Possibly missing opening '{'" : ")" === y.furthestChar ? b += ". Possibly missing opening '('" : y.furthestReachedEnd && (b += ". Possibly missing something")),
                    v = new O({
                        type: "Parse",
                        message: b,
                        index: y.furthest,
                ...
                var w = function(e) {
                    return (e = v || e || i.error) ? (e instanceof O || (e = new O(e,i,n.filename)),
                    l(e)) : l(null, c)
                };
            ...
            parsers: r = {
                primary: function() {
                    for (var e, t = this.mixin, i = []; ; ) {
                        ...
                        if (e = this.extendRule())
                            i = i.concat(e);
                        else if (e = t.definition() || this.declaration() || t.call(!1, !1) || this.ruleset() || this.variableCall() || this.entities.call() || this.atrule())
                            i.push(e);
                        else {
                            for (var n = !1; s.$char(";"); )
                                n = !0;
                ...
                entities: {
                    ...
                    keyword: function() {
                        ...
                        if (e)
                            return _e.Color.fromKeyword(e) || new _e.Keyword(e)
                    },
                    call: function() {
                        var e, t, i, r = s.i;
                        if (!s.peek(/^url\(/i))
                    ...
                    arguments: function(e) {
                        ...
                        for (s.save(); ; ) {
                            if (e)
                                ...
                                if (!(i = r.detachedRuleset() || this.assignment() || r.expression()))
                                    break;
                                i.value && 1 == i.value.length && (i = i.value[0]),
                                n.push(i)
                            }
                            s.$char(",") || (s.$char(";") || t) && (t = !0,
                    ...
                    url: function() {
                        var e, t = s.i;
                        if (s.autoCommentAbsorb = !1,
                        s.$str("url("))
                            return e = this.quoted() || this.variable() || this.property() || s.$re(/^(?:(?:\\[\(\)'"])|[^\(\)'"])+/) || "",
                            s.autoCommentAbsorb = !0,
                            l(")"),
                            new _e.URL(null != e.value || e instanceof _e.Variable || e instanceof _e.Property ? e : new _e.Anonymous(e,t),t,n);
                        s.autoCommentAbsorb = !0
                    },
                    variable: function() {
                        var e, t, i = s.i;
                        if (s.save(),
                        "@" === s.currentChar() && (t = s.$re(/^@@?[\w-]+/))) {
                    ...
                    color: function() {
                        var e;
                        if (s.save(),
                        "#" === s.currentChar() && (e = s.$re(/^#([A-Fa-f0-9]{8}|[A-Fa-f0-9]{6}|[A-Fa-f0-9]{3,4})([\w.#\[])?/)) && !e[2])
                            return s.forget(),
                            new _e.Color(e[1],void 0,e[0]);
                        s.restore()
                    },
                    ...
                    javascript: function() {
                        ...
                        if (s.$char("`")) {
                            if (e = s.$re(/^[^`]*`/))
                                return s.forget(),
                                new _e.JavaScript(e.substr(0, e.length - 1),Boolean(i),t,n);
                ...
                variableCall: function(e) {
                    var t, i = s.i, o = !!e, a = e;
                    if (s.save(),
                    a || "@" === s.currentChar() && (a = s.$re(/^(@[\w-]+)(\(\s*\))?/))) {
                        if (!(t = this.mixin.ruleLookups()) && (o && "()" !== s.$str("()") || "()" !== a[2]))
                            return void s.restore("Missing '[...]' lookup in variable call");
                        o || (a = a[1]);
                        var l = new _e.VariableCall(a,i,n);
                        return !o && r.end() ? (s.forget(),
                        l) : (s.forget(),
                ...
                extend: function(e) {
                    ...
                    if (s.$str(e ? "&:extend(" : ":extend(")) {
                        do {
                            for (r = null,
                            t = null; !(r = s.$re(/^(all)(?=\s*(\)|,))/)) && (i = this.element()); )
                                t ? t.push(i) : t = [i];
                            r = r && r[1],
                            t || o("Missing target selector for :extend()."),
                            u = new _e.Extend(new _e.Selector(t),r,c,n),
                            l ? l.push(u) : l = [u]
                        } while (s.$char(","));
                        return a(/^\)/),
                        e && a(/^;/),
                ...
                mixin: {
                    call: function(e, t) {
                        var i, o, a, u, c = s.currentChar(), h = !1, f = s.i;
                        if ("." === c || "#" === c) {
                            if (s.save(),
                            o = this.elements()) {
                                if (s.$char("(") && (a = this.args(!0).args,
                                l(")"),
                                u = !0),
                    ...
                    elements: function() {
                        for (var e, t, i, r, o, a = /^[#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/; o = s.i,
                        t = s.$re(a); )
                    ...
                    args: function(e) {
                        var t, i, n, a, l, u, c, h = r.entities, f = {
                            args: null,
                            variadic: !1
                        }, p = [], v = [], d = [], m = !0;
                        for (s.save(); ; ) {
                            ...
                            l = u;
                            var g = null;
                            if (e ? u.value && 1 == u.value.length && (g = u.value[0]) : g = u,
                            g && (g instanceof _e.Variable || g instanceof _e.Property))
                                if (s.$char(":")) {
                                    if (p.length > 0 && (t && o("Cannot mix ; and , as delimiter types"),
                                    i = !0),
                            ...
                            s.$char(",") ? m = !0 : ((m = ";" === s.$char(";")) || t) && (i && o("Cannot mix ; and , as delimiter types"),
                            t = !0,
                    ...
                    definition: function() {
                        ...
                        if (!("." !== s.currentChar() && "#" !== s.currentChar() || s.peek(/^[^{]*\}/)))
                            ...
                            t = s.$re(/^([#.](?:[\w-]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+)\s*\(/)) {
                                ...
                                i = r.block())
                                    return s.forget(),
                                    new _e.mixin.Definition(e,o,i,n,l);
                                s.restore()
                            } else
                                s.restore()
                    },
                ...
                ieAlpha: function() {
                    var e;
                    if (s.$re(/^opacity=/i))
                        return (e = s.$re(/^\d+/)) || (e = "@{" + (e = a(r.entities.variable, "Could not parse alpha")).name.slice(1) + "}"),
                        l(")"),
                ...
                element: function() {
                    ...
                    (e = s.$re(/^(?:\d+\.\d+|\d+)%/) || s.$re(/^(?:[.#]?|:*)(?:[\w-]|[^\x00-\x9f]|\\(?:[A-Fa-f0-9]{1,6} ?|[^A-Fa-f0-9]))+/) || s.$char("*") || s.$char("&") || this.attribute() || s.$re(/^\([^&()@]+\)/) || s.$re(/^[\.#:](?=@)/) || this.entities.variableCurly()) || (s.save(),
                    s.$char("(") ? (i = this.selector(!1)) && s.$char(")") ? (e = new _e.Paren(i),
                    s.forget()) : s.restore("Missing closing ')'") : s.forget()),
                    e)
                ...
                selector: function(e) {
                    ...
                    for (e = !1 !== e; (e && (i = this.extend()) || e && (c = s.$str("when")) || (l = this.element())) && (c ? h = a(this.conditions, "expected condition") : h ? o("CSS guard can only be used at the end of selector") : i ? u = u ? u.concat(i) : i : (u && o("Extend can only be used at the end of selector"),
                    r = s.currentChar(),
                    t ? t.push(l) : t = [l],
                    l = null),
                    "{" !== r && "}" !== r && ";" !== r && "," !== r && ")" !== r); )
                        ;
                    if (t)
                        return new _e.Selector(t,u,h,f,n);
                    u && o("Extend must be used to extend a selector, it cannot be used on its own")
                },
                selectors: function() {
                    for (var e, t; (e = this.selector()) && (t ? t.push(e) : t = [e],
                    s.commentStore.length = 0,
                    e.condition && t.length > 1 && o("Guards are only currently allowed on a single selector."),
                    s.$char(",")); )
                ...
                attribute: function() {
                    if (s.$char("[")) {
                        ...
                        return (e = r.variableCurly()) || (e = a(/^(?:[_A-Za-z0-9-\*]*\|)?(?:[_A-Za-z0-9-]|\\.)+/)),
                        (i = s.$re(/^[|~*$^]?=/)) && (t = r.quoted() || s.$re(/^[0-9]+%/) || s.$re(/^[\w-]+/) || r.variableCurly()) && (n = s.$re(/^[iIsS]/)),
                        l("]"),
                ...
                block: function() {
                    var e;
                    if (s.$char("{") && (e = this.primary()) && s.$char("}"))
                        return e
                },
                blockRuleset: function() {
                    var e = this.block();
                    return e && (e = new _e.Ruleset(null,e)),
                    e
                },
                detachedRuleset: function() {
                    var e, t, i;
                    if (s.save(),
                    !s.$re(/^[.#]\(/) || (t = (e = this.mixin.args(!1)).args,
                    i = e.variadic,
                    s.$char(")"))) {
                        var n = this.blockRuleset();
                        if (n)
                            return s.forget(),
                            t ? new _e.mixin.Definition(null,t,n,null,i) : new _e.DetachedRuleset(n);
                        s.restore()
                    } else
                        s.restore()
                },
                ruleset: function() {
                    ...
                    (e = this.selectors()) && (i = this.block())) {
                        ...
                        return t.dumpLineNumbers && (r.debugInfo = n),
                        r
                    }
                    s.restore()
                },
                declaration: function() {
                    var e, t, i, r, o, a, l = s.i, u = s.currentChar();
                    if ("." !== u && "#" !== u && "&" !== u && ":" !== u)
                        if (s.save(),
                        e = this.variable() || this.ruleProperty()) {
                            if ((a = "string" == typeof e) && (t = this.detachedRuleset()) && (i = !0),
                            s.commentStore.length = 0,
                            !t) {
                                if (o = !a && e.length > 1 && e.pop().value,
                                t = e[0].value && "--" === e[0].value.slice(0, 2) ? this.permissiveValue() : this.anonymousValue())
                                    return s.forget(),
                                    new _e.Declaration(e,t,!1,o,l,n);
                                t || (t = this.value()),
                ...
                anonymousValue: function() {
                    var e = s.i
                      , t = s.$re(/^([^.#@\$+\/'"*`(;{}-]*);/);
                    if (t)
                        return new _e.Anonymous(t[1],e)
                },
                permissiveValue: function(e) {
                    var t, i, r, a, l = e || ";", u = s.i, c = [];
                    function h() {
                        var e = s.currentChar();
                    ...
                    if (!h()) {
                        ...
                        if (r = h(),
                        a.length > 0) {
                            if (a = new _e.Expression(a),
                            r)
                                return a;
                            c.push(a),
                            " " === s.prevChar() && c.push(new _e.Anonymous(" ",u))
                        }
                        if (s.save(),
                        a = s.$parseUntil(l)) {
                            if ("string" == typeof a && o("Expected '" + a + "'", "Parse"),
                            1 === a.length && " " === a[0])
                                return s.forget(),
                                new _e.Anonymous("",u);
                            var f = void 0;
                            for (t = 0; t < a.length; t++)
                                if (f = a[t],
                                Array.isArray(f))
                                    c.push(new _e.Quoted(f[0],f[1],!0,u,n));
                                else {
                            ...
                            return s.forget(),
                            new _e.Expression(c,!0)
                        }
                        s.restore()
                    }
                },
                import: function() {
                    var e, t, i = s.i, r = s.$re(/^@import\s+/);
                    if (r) {
                        var a = (r ? this.importOptions() : null) || {};
                        if (e = this.entities.quoted() || this.entities.url())
                            return t = this.mediaFeatures(),
                            s.$char(";") || (s.i = i,
                            o("missing semi-colon or unrecognised media features on import")),
                            t = t && new _e.Value(t),
                            new _e.Import(e,t,a,i,n);
                        s.i = i,
                        o("malformed import statement")
                    }
                },
                ...
                mediaFeature: function() {
                    var e, t, i = this.entities, r = [];
                    s.save();
                    do {
                        (e = i.keyword() || i.variable() || i.mixinLookup()) ? r.push(e) : s.$char("(") && (t = this.property(),
                        e = this.value(),
                        s.$char(")") ? t && e ? r.push(new _e.Paren(new _e.Declaration(t,e,null,null,s.i,n,!0))) : e ? r.push(new _e.Paren(e)) : o("badly formed media feature definition") : o("Missing closing ')'", "Parse"))
                    } while (e);
                    if (s.forget(),
                    r.length > 0)
                ...
                mediaFeatures: function() {
                    var e, t = this.entities, i = [];
                    do {
                        if (e = this.mediaFeature()) {
                            if (i.push(e),
                            !s.$char(","))
                                break
                        } else if ((e = t.variable() || t.mixinLookup()) && (i.push(e),
                        !s.$char(",")))
                            break
                    } while (e);
                ...
                media: function() {
                    var e, i, r, a, l = s.i;
                    if (t.dumpLineNumbers && (a = u(l)),
                    s.save(),
                    s.$str("@media"))
                        return e = this.mediaFeatures(),
                        (i = this.block()) || o("media definitions require block statements after any features"),
                        s.forget(),
                ...
                atrule: function() {
                    var e, i, r, a, l, c, h, f = s.i, p = !0, v = !0;
                    if ("@" === s.currentChar()) {
                        ...
                        e = s.$re(/^@[a-z-]+/)) {
                            switch (a = e,
                            "-" == e.charAt(1) && e.indexOf("-", 2) > 0 && (a = "@" + e.slice(e.indexOf("-", 2) + 1)),
                            a) {
                            case "@charset":
                                l = !0,
                                p = !1;
                            ...
                            if (s.commentStore.length = 0,
                            l ? (i = this.entity()) || o("expected " + e + " identifier") : c ? (i = this.expression()) || o("expected " + e + " expression") : h && (i = this.permissiveValue(/^[{;]/),
                            p = "{" === s.currentChar(),
                            i ? i.value || (i = null) : p || ";" === s.currentChar() || o(e + " rule is missing block or ending semi-colon")),
                            p && (r = this.blockRuleset()),
                            r || !p && i && s.$char(";"))
                                return s.forget(),
                                new _e.AtRule(e,i,r,f,n,t.dumpLineNumbers ? u(f) : null,v);
                ...
                value: function() {
                    var e, t = [], i = s.i;
                    do {
                        if ((e = this.expression()) && (t.push(e),
                        !s.$char(",")))
                            break
                    } while (e);
                    if (t.length > 0)
                        return new _e.Value(t,i)
                },
                important: function() {
                    if ("!" === s.currentChar())
                ...
                sub: function() {
                    ...
                    if (s.save(),
                    s.$char("("))
                        return (e = this.addition()) && s.$char(")") ? (s.forget(),
                        (t = new _e.Expression([e])).parens = !0,
                        t) : void s.restore("Expected ')'");
                    s.restore()
                },
                ...
                atomicCondition: function(e) {
                    var t, i, n, r, a = this.entities, l = s.i;
                    function u() {
                        return this.addition() || a.keyword() || a.quoted() || a.mixinLookup()
                    }
                    if (t = (u = u.bind(this))())
                        return s.$char(">") ? r = s.$char("=") ? ">=" : ">" : s.$char("<") ? r = s.$char("=") ? "<=" : "<" : s.$char("=") && (r = s.$char(">") ? "=>" : s.$char("<") ? "=<" : "="),
                        r ? (i = u()) ? n = new _e.Condition(r,t,i,l,!1) : o("expected expression") : n = new _e.Condition("=",t,new _e.Keyword("true"),l,!1),
                        n
                },
                operand: function() {
                ...
                expression: function() {
                    var e, t, i = [], n = s.i;
                    do {
                        (e = this.comment()) ? i.push(e) : ((e = this.addition() || this.entity())instanceof _e.Comment && (e = null),
                        e && (i.push(e),
                        s.peek(/^\/[\/*]/) || (t = s.$char("/")) && i.push(new _e.Anonymous(t,n))))
                    } while (e);
                    if (i.length > 0)
                        return new _e.Expression(i)
                },
                property: function() {
                ...
                ruleProperty: function() {
                    ...
                    if (i.length > 1 && a(/^((?:\+_|\+)?)\s*:/)) {
                        ...
                        t = 0; t < i.length; t++)
                            e = i[t],
                            i[t] = "@" !== e.charAt(0) && "$" !== e.charAt(0) ? new _e.Keyword(e) : "@" === e.charAt(0) ? new _e.Variable("@" + e.slice(2, -1),r[t],n) : new _e.Property("$" + e.slice(2, -1),r[t],n);
                        return i
                    }
                    s.restore()
                }
    ...
    var Ye = We = {
        ...
        rgba: function(e, t, i, n) {
            try {
                if (e instanceof c)
                    return n = t ? Xe(t) : e.alpha,
                    new c(e.rgb,n,"rgba");
                var r = [e, t, i].map((function(e) {
                    return i = 255,
                    (t = e)instanceof ie && t.unit.is("%") ? parseFloat(t.value * i / 100) : Xe(t);
                    var t, i
                }
                ));
                return n = Xe(n),
        ...
        contrast: function(e, t, i, n) {
            if (!e.rgb)
                return null;
            if (void 0 === i && (i = We.rgba(255, 255, 255, 1)),
      ...
      , rt = {
        ...
        each: function(e, t) {
            ...
            var a = "@value"
              , l = "@key"
              , c = "@index";
            t.params ? (a = t.params[0] && t.params[0].name,
            ...
            for (var h = 0; h < n.length; h++) {
                var f = void 0
                  , p = void 0
                  , v = n[h];
                v instanceof D ? (f = "string" == typeof v.name ? v.name : v.name[0].value,
                p = v.value) : (f = new ie(h + 1),
                p = v),
                v instanceof T || (i = t.rules.slice(0),
                a && i.push(new D(a,p,!1,!1,this.index,this.currentFileInfo)),
                c && i.push(new D(c,new ie(h + 1),!1,!1,this.index,this.currentFileInfo)),
                l && i.push(new D(l,f,!1,!1,this.index,this.currentFileInfo)),
                s.push(new X([new F([new m("","&")])],i,t.strictImports,t.visibilityInfo())))
            }
    ...
    var lt = function(e, t) {
        ...
        var i, n, r, s, o, a, l, u, c = [], h = {};
        for (i = 0; i < t.length; i++)
            if ((r = t[i])instanceof ie)
                if (l = "" !== (a = "" === (s = "" === r.unit.toString() && void 0 !== u ? new ie(r.value,u).unify() : r.unify()).unit.toString() && void 0 !== l ? l : s.unit.toString()) && void 0 === l || "" !== a && "" === c[0].unify().unit.toString() ? a : l,
                u = "" !== a && void 0 === u ? r.unit.toString() : u,
                void 0 !== (n = void 0 !== h[""] && "" !== a && a === l ? h[""] : h[a]))
                    o = "" === c[n].unit.toString() && void 0 !== u ? new ie(c[n].value,u).unify() : c[n].unify(),
                ...
                Array.isArray(t[i].value) && Array.prototype.push.apply(t, Array.prototype.slice.call(t[i].value));
      ...
      , pt = {
        ...
        unit: function(e, t) {
            ...
            return t = t ? t instanceof L ? t.value : t.toCSS() : "",
            new ie(e.value,t)
        },
        "get-unit": function(e) {
            return new j(e.unit)
      ...
      , vt = function(e) {
        ...
        return Z.addMultiple(Je),
        Z.add("default", Q.eval.bind(Q)),
        Z.addMultiple(Ye),
        Z.addMultiple(et),
        Z.addMultiple(function(e) {
            var t = function(e, t) {
            ...
            return {
                "data-uri": function(i, n) {
                    ...
                    if (i)
                        ...
                        if ("image/svg+xml" === (s = e.mimeLookup(o)))
                            p = !1;
                        else {
                    ...
                    if (!d.contents)
                        return r.warn("Skipped data-uri embedding of " + o + " because file not found"),
                        t(this, n || i);
                    var m = d.contents;
                    if (p && !e.encodeBase64)
                        return t(this, n);
        ...
        Z.addMultiple({
            "svg-gradient": function(e) {
                var t, i, n, r, s, o, a, l, u = "linear", h = 'x="0" y="0" width="1" height="1"', f = {
                    compress: !1
                }, p = e.toCSS(f);
                function v() {
                    throw {
                ...
                switch (2 == arguments.length ? (arguments[1].value.length < 2 && v(),
                t = arguments[1].value) : arguments.length < 3 ? v() : t = Array.prototype.slice.call(arguments, 1),
                p) {
                case "to bottom":
                ...
                for (n = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1 1"><' + u + 'Gradient id="g" ' + i + ">",
                r = 0; r < t.length; r += 1)
                    t[r]instanceof se ? (s = t[r].value[0],
                    o = t[r].value[1]) : (s = t[r],
                    o = void 0),
                    s instanceof c && ((0 === r || r + 1 === t.length) && void 0 === o || o instanceof ie) || v(),
                    a = o ? o.toCSS(f) : 0 === r ? "0%" : "100%",
                    l = s.alpha,
                    n += '<stop offset="' + a + '" stop-color="' + s.toRGB() + '"' + (l < 1 ? ' stop-opacity="' + l + '"' : "") + "/>";
                return n += "</" + u + "Gradient><rect " + h + ' fill="url(#g)" /></svg>',
                n = encodeURIComponent(n),
                new fe(new he("'" + (n = "data:image/svg+xml," + n) + "'",n,!1,this.index,this.currentFileInfo),this.index,this.currentFileInfo)
            }
        }),
        Z.addMultiple(pt),
        t
    ...
    function dt(e, t) {
        var i, n = (t = t || {}).variables, r = new z.Eval(t);
        "object" != typeof n || Array.isArray(n) || (n = Object.keys(n).map((function(e) {
            var t = n[e];
            return t instanceof _e.Value || (t instanceof _e.Expression || (t = new _e.Expression([t])),
            t = new _e.Value([t])),
        ...
        if (t.pluginManager) {
            ...
            for (var u = 0; u < 2; u++)
                for (o.first(); s = o.get(); )
                    s.isPreEvalVisitor ? 0 !== u && -1 !== l.indexOf(s) || (l.push(s),
                    s.run(e)) : 0 !== u && -1 !== a.indexOf(s) || (s.isPreVisitor ? a.unshift(s) : a.push(s))
        }
        i = e.eval(r);
    ...
    function St(e, t) {
            ...
            return function() {
                ...
                return t.prototype.toCSS = function(t) {
                    ...
                    try {
                        ...
                        t.sourceMap ? (n = new e(t.sourceMap),
                        s.css = n.toCSS(i, a, this.imports)) : s.css = i.toCSS(a)
                    } catch (e) {
                        throw new O(e,this.imports)
                    }
                    if (t.pluginManager)
                    ...
                    s.imports = [],
                    this.imports.files)
                        this.imports.files.hasOwnProperty(c) && c !== this.imports.rootFilename && s.imports.push(c);
                    return s
                }
                ,
                t
            ...
            return function() {
                ...
                return i.prototype.toCSS = function(t, i, n) {
                    var r = new e({
                      ...
                      , s = r.toCSS(i);
                    return this.sourceMap = r.sourceMap,
                    this.sourceMapURL = r.sourceMapURL,
                    this.options.sourceMapInputFilename && (this.sourceMapInputFilename = r.normalizeFilename(this.options.sourceMapInputFilename)),
                    void 0 !== this.options.sourceMapBasepath && void 0 !== this.sourceMapURL && (this.sourceMapURL = r.removeBasepath(this.sourceMapURL)),
            ...
            return function() {
                ...
                t.prototype.add = function(e, t, i, n) {
                    if (e) {
                        ...
                        1 === r.length ? this._column += o.length : (this._lineNumber += r.length - 1,
                ...
                t.prototype.toCSS = function(e) {
                    ...
                    this._outputSourceFiles)
                        for (var t in this._contentsMap)
                            if (this._contentsMap.hasOwnProperty(t)) {
                                ...
                                this._contentsIgnoredCharsMap[t] && (i = i.slice(this._contentsIgnoredCharsMap[t])),
                    ...
                    this._css.length > 0) {
                        ...
                        this.sourceMapURL ? n = this.sourceMapURL : this._sourceMapFilename && (n = this._sourceMapFilename),
                        this.sourceMapURL = n,
                        this.sourceMap = r
                    }
            ...
            return function() {
                ...
                return t.prototype.push = function(t, i, n, s, o) {
                    ...
                    var u = function(e, i, n) {
                        ...
                        r.info("The file " + n + " was skipped because it was not found and the import was marked optional.")) : (a.files[n] || s.inline || (a.files[n] = {
                            root: i,
                            options: s
                        }),
                        e && !a.error && (a.error = e),
                    ...
                    if (h) {
                        var f, p, v = function(e) {
                            ...
                            s.isPlugin ? (t = l.evalPlugin(r, o, a, s.pluginArgs, c))instanceof O ? u(t, null, i) : u(null, t, i) : s.inline ? u(null, r, i) : !a.files[i] || a.files[i].options.multiple || s.multiple ? new Te(o,a,c).parse(r, (function(e, t) {
                                u(e, t, i)
                            }
                            )) : u(null, a.files[i].root, i)
                        }, d = _(this.context);
                        i && (d.ext = s.isPlugin ? ".js" : ".less"),
                        s.isPlugin ? (d.mime = "application/javascript",
                        d.syncImport ? f = l.loadPluginSync(t, n.currentDirectory, d, e, h) : p = l.loadPlugin(t, n.currentDirectory, d, e, h)) : d.syncImport ? f = h.loadFileSync(t, n.currentDirectory, d, e) : p = h.loadFile(t, n.currentDirectory, d, e, (function(e, t) {
                            e ? u(e) : v(t)
                        }
                        )),
        ...
        var u, c = function(e, t, i) {
            var n = function(e, i, r) {
                ...
                i = M(this.options, {})) : i = M(this.options, i || {}),
                !r) {
                    var s = this;
            ...
            var n = function(e, t, r) {
                ...
                t = M(this.options, {})) : t = M(this.options, t || {}),
                !r) {
                    var s = this;
                ...
                var o, a = void 0, l = new yt(this,!t.reUsePluginManager);
                if (t.pluginManager = l,
                o = new z.Parse(t),
                t.rootFileInfo)
                    a = t.rootFileInfo;
                else {
        ...
        for (var m in p.tree)
            if ("function" == typeof (u = p.tree[m]))
                d[m.toLowerCase()] = v(u);
            else
                for (var g in d[m] = Object.create(null),
                u)
                    d[m][g.toLowerCase()] = v(u[g]);
        return p.parse = p.parse.bind(d),
        p.render = p.render.bind(d),
        d
    }
    var It = {}
      , Ct = function() {};
    Ct.prototype = Object.assign(new Ae, {
        ...
        doXHR: function(e, t, i, n) {
            ...
            r.send(null),
            bt.isFileProtocol && !bt.fileAsync ? 0 === r.status || r.status >= 200 && r.status < 300 ? i(r.responseText) : n(r.status, e) : s ? r.onreadystatechange = function() {
        ...
        return {
            add: function(s, o) {
                r.errorReporting && "html" !== r.errorReporting ? "console" === r.errorReporting ? function(e, t) {
                    ...
                    var o, a, l = "less-error-message:" + e(s || ""), u = t.document.createElement("div"), c = [], h = n.filename || s, f = h.match(/([^\/]+(\?.*)?)$/)[1];
                    u.id = l,
                    u.className = "less-error-message",
                    a = "<h3>" + (n.type || "Syntax") + "Error: " + (n.message || "There is an error in your .less file") + '</h3><p>in <a href="' + h + '">' + f + "</a> ";
                    ...
                    p(n, 1, "line"),
                    p(n, 2, ""),
                    a += "on line " + n.line + ", column " + (n.column + 1) + ":</p><ul>" + c.join("") + "</ul>"),
                    n.stack && (n.extract || r.logLevel >= 4) && (a += "<br/>Stack Trace</br />" + n.stack.split("\n").slice(1).join("<br/>")),
                    u.innerHTML = a,
                    ...
                    u.style.cssText = ["font-family: Arial, sans-serif", "border: 1px solid #e00", "background-color: #eee", "border-radius: 5px", "-webkit-border-radius: 5px", "-moz-border-radius: 5px", "color: #e00", "padding: 15px", "margin-bottom: 15px"].join(";"),
                    "development" === r.env && (o = setInterval((function() {
                        var e = t.document
                          , i = e.body;
                        i && (e.getElementById(l) ? i.replaceChild(u, e.getElementById(l)) : i.insertBefore(u, i.firstChild),
                        clearInterval(o))
                    }
                    ), 10))
                }(s, o)
    ...
    var Pt, Rt, Ot, Vt = function(e, n) {
          ...
          , c = s.cache = n.cache || function(e, t, i) {
            ...
            return {
                ...
                getCSS: function(e, t, i) {
                    ...
                    if (i = i || {},
                    o = o || "{}",
                    s && t.lastModified && new Date(t.lastModified).valueOf() === new Date(s).valueOf() && JSON.stringify(i) === o)
                        return r
                }
            }
        }(e, n, s.logger);
        ...
        function v(e) {
            for (var t, i = r.getElementsByTagName("style"), o = 0; o < i.length; o++)
                if ((t = i[o]).type.match(h)) {
                    ...
                    s.render(l, a, p((function(e, t, i) {
                        t ? u.add(t, "inline") : (e.type = "text/css",
        ...
        function d(e, i, r, a, h) {
            ...
            p.mime = e.type,
            h && (p.modifyVars = h),
            l.loadFile(e.href, null, p, o).then((function(t) {
                !function(t) {
                    var n = t.contents
                      , o = t.filename
                      , h = t.webInfo
                    ...
                    s.render(n, p, (function(t, r) {
                        t ? (t.href = o,
                        i(t)) : (c.setCSS(e.href, h.lastModified, p.modifyVars, r.css),
        ...
        return s.watch = function() {
            return s.watchMode || (s.env = "development",
            "development" === s.env && (s.watchTimer = setInterval((function() {
                s.watchMode && (l.clearFileCache(),
        ...
        ,
        s.unwatch = function() {
            return clearInterval(s.watchTimer),
            this.watchMode = !1,
            !1
        }
        ,
        s.registerStylesheetsImmediately = function() {
            ...
            s.sheets = [];
            for (var t = 0; t < e.length; t++)
                ("stylesheet/less" === e[t].rel || e[t].rel.match(/stylesheet/) && e[t].type.match(h)) && s.sheets.push(e[t])
        }
        ,
        ...
        s.refresh = function(t, n, r) {
            return (t || r) && !1 !== r && l.clearFileCache(),
            new Promise((function(r, o) {
                var a, l, c, h;
                a = l = new Date,
                0 === (h = s.sheets.length) ? (l = new Date,
                c = l - a,
                ...
                r({
                    ...
                    if (t)
                        ...
                        void o(t);
                    v.local ? s.logger.info("Loading " + p.href + " from cache.") : s.logger.info("Rendered " + p.href + " successfully."),
                    i(e.document, n, p),
                    s.logger.info("CSS for " + p.href + " generated in " + (new Date - l) + "ms"),
                    0 === --h && (c = new Date - a,
    ...
    function Ft(e) {
        ...
        Mt.async || Rt.removeChild(Ot)
    }
    return window.less = Vt,
    Mt.onReady && (/!watch/.test(window.location.hash) && Vt.watch(),
    Mt.async || (Pt = "body { display: none !important }",
    Rt = document.head || document.getElementsByTagName("head")[0],
    (Ot = document.createElement("style")).type = "text/css",
    Ot.styleSheet ? Ot.styleSheet.cssText = Pt : Ot.appendChild(document.createTextNode(Pt)),
    Rt.appendChild(Ot)),
    Vt.registerStylesheetsImmediately(),
    Vt.pageLoadFinished = Vt.refresh("development" === Vt.env).then(Ft, Ft)),
    Vt
}
));
