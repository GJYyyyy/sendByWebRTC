 ...
 * Original file: /npm/webrtc-adapter@9.0.3/out/adapter.js
 *
    ...
    return function e(t, r, n) {
        ...
        2: [function(e, t, r) {
            ...
            r.adapterFactory = function() {
                ...
                case "chrome":
                    ...
                    d.browserShim = o,
                    c.shimAddIceCandidateNullOrEmpty(t, u),
                    c.shimParameterlessSetLocalDescription(t, u),
                    o.shimGetUserMedia(t, u),
                    o.shimMediaStream(t, u),
                    o.shimPeerConnection(t, u),
                    o.shimOnTrack(t, u),
                    o.shimAddTrackRemoveTrack(t, u),
                    o.shimGetSendersWithDtmf(t, u),
                    o.shimSenderReceiverGetStats(t, u),
                    o.fixNegotiationNeeded(t, u),
                    c.shimRTCIceCandidate(t, u),
                    c.shimRTCIceCandidateRelayProtocol(t, u),
                    c.shimConnectionState(t, u),
                    c.shimMaxMessageSize(t, u),
                    c.shimSendThrowTypeError(t, u),
                    c.removeExtmapAllowMixed(t, u);
                    break;
                case "firefox":
        ...
        3: [function(e, t, r) {
            ...
            r.fixNegotiationNeeded = function(e, t) {
                n.wrapPeerConnectionEvent(e, "negotiationneeded", (function(e) {
                    var r = e.target;
                    if (!(t.version < 72 || r.getConfiguration && "plan-b" === r.getConfiguration().sdpSemantics) || "stable" === r.signalingState)
                        return e
                }
                ))
            }
            ...
            r.shimOnTrack = function(e) {
                if ("object" === s(e) && e.RTCPeerConnection && !("ontrack"in e.RTCPeerConnection.prototype)) {
            ...
            r.shimSenderReceiverGetStats = function(e) {
                if (!("object" === s(e) && e.RTCPeerConnection && e.RTCRtpSender && e.RTCRtpReceiver))
                    return;
        ...
        4: [function(e, t, r) {
            ...
            r.shimGetUserMedia = function(e, t) {
                ...
                if (!r.mediaDevices)
                    return;
                var n = function(e) {
                    if ("object" !== i(e) || e.mandatory || e.optional)
                        return e;
                    var t = {};
                    return Object.keys(e).forEach((function(r) {
                        if ("require" !== r && "advanced" !== r && "mediaSource" !== r) {
                            var n = "object" === i(e[r]) ? e[r] : {
                                ideal: e[r]
                            };
                            ...
                            if (void 0 !== n.ideal) {
                                ...
                                var a = {};
                                "number" == typeof n.ideal ? (a[o("min", r)] = n.ideal,
                                t.optional.push(a),
                                (a = {})[o("max", r)] = n.ideal,
                                t.optional.push(a)) : (a[o("", r)] = n.ideal,
                                t.optional.push(a))
                            }
                            void 0 !== n.exact && "number" != typeof n.exact ? (t.mandatory = t.mandatory || {},
                            t.mandatory[o("", r)] = n.exact) : ["min", "max"].forEach((function(e) {
                  ...
                  , a = function(e, a) {
                    ...
                    if (e && "object" === i(e.video)) {
                        ...
                        var p, u = t.version < 66;
                        if (c && ("user" === c.exact || "environment" === c.exact || "user" === c.ideal || "environment" === c.ideal) && (!r.mediaDevices.getSupportedConstraints || !r.mediaDevices.getSupportedConstraints().facingMode || u))
                            if (delete e.video.facingMode,
                            "environment" === c.exact || "environment" === c.ideal ? p = ["back", "rear"] : "user" !== c.exact && "user" !== c.ideal || (p = ["front"]),
                            p)
        ...
        5: [function(e, t, r) {
            ...
            r.removeExtmapAllowMixed = function(e, t) {
                ...
                if ("chrome" === t.browser && t.version >= 71)
                    return;
                if ("safari" === t.browser && t._safariVersion >= 13.1)
                    return;
            ...
            r.shimAddIceCandidateNullOrEmpty = function(e, t) {
                ...
                e.RTCPeerConnection.prototype.addIceCandidate = function() {
                    return arguments[0] ? ("chrome" === t.browser && t.version < 78 || "firefox" === t.browser && t.version < 68 || "safari" === t.browser) && arguments[0] && "" === arguments[0].candidate ? Promise.resolve() : r.apply(this, arguments) : (arguments[1] && arguments[1].apply(null),
                    Promise.resolve())
                }
            }
            ,
            ...
            r.shimMaxMessageSize = function(e, t) {
                ...
                e.RTCPeerConnection.prototype.setRemoteDescription = function() {
                    var e, n;
                    (this._sctp = null,
                    "chrome" === t.browser && t.version >= 76) && ("plan-b" === this.getConfiguration().sdpSemantics && Object.defineProperty(this, "sctp", {
                        get: function() {
                            return void 0 === this._sctp ? null : this._sctp
                        },
                        enumerable: !0,
                    ...
                    if (function(e) {
                        ...
                        n), c = function(e, r) {
                            ...
                            return o.length > 0 ? n = parseInt(o[0].substring(19), 10) : "firefox" === t.browser && -1 !== r && (n = 2147483637),
                            n
                        }(arguments[0], a);
                        o = 0 === s && 0 === c ? Number.POSITIVE_INFINITY : 0 === s || 0 === c ? Math.max(s, c) : Math.min(s, c);
                        var p = {};
            ...
            r.shimParameterlessSetLocalDescription = function(e, t) {
                ...
                e.RTCPeerConnection.prototype.setLocalDescription = function() {
                    ...
                    return t.sdp || "offer" !== t.type && "answer" !== t.type ? r.apply(this, [t]) : ("offer" === t.type ? this.createOffer : this.createAnswer).apply(this).then((function(t) {
                        return r.apply(e, [t])
                    }
                    ))
                }
            ...
            r.shimRTCIceCandidate = function(e) {
                ...
                e.RTCIceCandidate = function(e) {
                    if ("object" === s(e) && e.candidate && 0 === e.candidate.indexOf("a=") && ((e = JSON.parse(JSON.stringify(e))).candidate = e.candidate.substring(2)),
                    e.candidate && e.candidate.length) {
                        var r = new t(e)
                          , n = i.default.parseCandidate(e.candidate);
                        for (var o in n)
            ...
            r.shimRTCIceCandidateRelayProtocol = function(e) {
                if (!e.RTCIceCandidate || e.RTCIceCandidate && "relayProtocol"in e.RTCIceCandidate.prototype)
                    return;
                o.wrapPeerConnectionEvent(e, "icecandidate", (function(e) {
                    if (e.candidate) {
                        var t = i.default.parseCandidate(e.candidate.candidate);
            ...
            ;
            var n, i = (n = e("sdp")) && n.__esModule ? n : {
                default: n
            }, o = function(e, t) {
                if (!t && e && e.__esModule)
                    return e;
        ...
        6: [function(e, t, r) {
            ...
            r.shimAddTransceiver = function(e) {
                ...
                t && (e.RTCPeerConnection.prototype.addTransceiver = function() {
                    ...
                    var e, r = arguments[1] && arguments[1].sendEncodings;
                    void 0 === r && (r = []);
                    var n = (r = function(e) {
                        if (Array.isArray(e))
                            return s(e)
                    ...
                    if (n) {
                        var o = i.sender
                          , a = o.getParameters();
                        (!("encodings"in a) || 1 === a.encodings.length && 0 === Object.keys(a.encodings[0]).length) && (a.encodings = r,
                        o.sendEncodings = r,
                        this.setParametersPromises.push(o.setParameters(a).then((function() {
            ...
            r.shimPeerConnection = function(e, t) {
                ...
                t.version < 53 && ["setLocalDescription", "setRemoteDescription", "addIceCandidate"].forEach((function(t) {
                    var r, n, i, o = e.RTCPeerConnection.prototype[t], a = (r = {},
                    i = function() {
                        return arguments[0] = new ("addIceCandidate" === t ? e.RTCIceCandidate : e.RTCSessionDescription)(arguments[0]),
                    ...
                    }(n = t))in r ? Object.defineProperty(r, n, {
                        value: i,
                        enumerable: !0,
                        configurable: !0,
                        writable: !0
            ...
            r.shimReceiverGetStats = function(e) {
                if ("object" !== c(e) || !e.RTCPeerConnection || !e.RTCRtpSender)
                    return;
            ...
            r.shimGetUserMedia = function(e, t) {
                ...
                !(t.version > 55 && "autoGainControl"in r.mediaDevices.getSupportedConstraints())) {
                    ...
                    if (r.mediaDevices.getUserMedia = function(e) {
                        return "object" === o(e) && "object" === o(e.audio) && (e = JSON.parse(JSON.stringify(e)),
                    ...
                    if (i && i.prototype.applyConstraints) {
                        ...
                        i.prototype.applyConstraints = function(e) {
                            return "audio" === this.kind && "object" === o(e) && (e = JSON.parse(JSON.stringify(e)),
                ...
                e.RTCPeerConnection = function(e, r) {
                    if (e && e.iceServers) {
                        for (var i = [], o = 0; o < e.iceServers.length; o++) {
                            ...
                            void 0 === a.urls && a.url ? (n.deprecated("RTCIceServer.url", "RTCIceServer.urls"),
        ...
        10: [function(e, t, r) {
            ...
            r.compactObject = function e(t) {
                ...
                return Object.keys(t).reduce((function(r, i) {
                    var o, a, c, p = s(t[i]), u = p ? e(t[i]) : t[i], d = p && !Object.keys(u).length;
                    return void 0 === u || d ? r : Object.assign(r, (o = {},
                    c = u,
                    (a = function(e) {
                        var t = function(e, t) {
                            if ("object" != n(e) || !e)
                    ...
                    }(a = i))in o ? Object.defineProperty(o, a, {
                        value: c,
                        enumerable: !0,
                        configurable: !0,
                        writable: !0
            ...
            r.detectBrowser = function(e) {
                ...
                if (r.mozGetUserMedia)
                    t.browser = "firefox",
                    t.version = parseInt(a(r.userAgent, /Firefox\/(\d+)\./, 1));
                else if (r.webkitGetUserMedia || !1 === e.isSecureContext && e.webkitRTCPeerConnection)
                    t.browser = "chrome",
                    t.version = parseInt(a(r.userAgent, /Chrom(e|ium)\/(\d+)\./, 2));
                else {
                    if (!e.RTCPeerConnection || !r.userAgent.match(/AppleWebKit\/(\d+)\./))
                        return t.browser = "Not a supported browser.",
                        t;
                    t.browser = "safari",
                    t.version = parseInt(a(r.userAgent, /AppleWebKit\/(\d+)\./, 1)),
                    t.supportsUnifiedPlan = e.RTCRtpTransceiver && "currentDirection"in e.RTCRtpTransceiver.prototype,
                    t._safariVersion = a(r.userAgent, /Version\/(\d+(\.?\d+))/, 1)
                }
                return t
            }
            ,
            r.disableLog = function(e) {
                if ("boolean" != typeof e)
                    return new Error("Argument type: " + n(e) + ". Please use a boolean.");
                return i = e,
            ...
            r.wrapPeerConnectionEvent = function(e, t, r) {
                ...
                n.removeEventListener = function(e, r) {
                    ...
                    return this._eventMap[t].delete(r),
            ...
            function a(e, t, r) {
                var n = e.match(t);
                return n && n.length >= r && parseFloat(n[r], 10)
            }
            function s(e) {
        ...
        11: [function(e, t, r) {
            ...
            i.parseFmtp = function(e) {
                for (var t = {}, r = void 0, n = e.substring(e.indexOf(" ") + 1).split(";"), i = 0; i < n.length; i++)
            ...
            i.parseSsrcMedia = function(e) {
                var t = e.indexOf(" ")
                  ...
                  , n = e.indexOf(":", t);
                return n > -1 ? (r.attribute = e.substring(t + 1, n),
                r.value = e.substring(n + 1)) : r.attribute = e.substring(t + 1),
                r
            }
            ,
            ...
            i.writeCryptoLine = function(e) {
                return "a=crypto:" + e.tag + " " + e.cryptoSuite + " " + ("object" === n(e.keyParams) ? i.writeCryptoKeyParams(e.keyParams) : e.keyParams) + (e.sessionParams ? " " + e.sessionParams.join(" ") : "") + "\r\n"
            }
            ,
            ...
            i.parseRtpParameters = function(e) {
                ...
                for (var n = 3; n < r.length; n++) {
                    ...
                    if (a) {
                        ...
                        switch (s.parameters = c.length ? i.parseFmtp(c[0]) : {},
                ...
                var p = i.matchPrefix(e, "a=rtcp-fb:* ").map(i.parseRtcpFb);
            ...
            i.parseRtpEncodingParameters = function(e) {
                ...
                r.codecs.forEach((function(e) {
                    if ("RTX" === e.name.toUpperCase() && e.parameters.apt) {
                        ...
                        t.push(r),
                        n && ((r = JSON.parse(JSON.stringify(r))).fec = {
                            ssrc: s,
                ...
                return u.length && (u = 0 === u[0].indexOf("b=TIAS:") ? parseInt(u[0].substring(7), 10) : 0 === u[0].indexOf("b=AS:") ? 1e3 * parseInt(u[0].substring(5), 10) * .95 - 16e3 : void 0,
            ...
            i.parseSctpDescription = function(e) {
                var t = i.parseMLine(e)
                  ...
                  , n = void 0;
                r.length > 0 && (n = parseInt(r[0].substring(19), 10)),
                isNaN(n) && (n = 65536);
            ...
            i.getKind = function(e) {
                return i.splitLines(e)[0].split(" ")[0].substring(2)
            }
            ,
            ...
            i.parseMLine = function(e) {
                var t = i.splitLines(e)[0].substring(2).split(" ");
                return {
                    kind: t[0],
            ...
            i.parseOLine = function(e) {
                var t = i.matchPrefix(e, "o=")[0].substring(2).split(" ");
                return {
                    username: t[0],
                    sessionId: t[1],
...
//# sourceMappingURL=/sm/8195a6b5f9795679bc6e3ce0f49b9226c9c2eff5d00ce59dea5f13ac9f4685fd.map
